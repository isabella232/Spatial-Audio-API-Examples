...
UI.SCREEN_SHARE_BG_ASPECT_RATIO = 1;
UI.SCREEN_SHARE_ICON_RADIUS_M = AVATAR.RADIUS_M * 0.5;
UI.SCREEN_SHARE_HEADER_TIMEOUT_MS = 3000;
UI.SCREEN_SHARING_SHADOW_HEIGHT_PX = 7;
UI.SCREEN_SHARE_HOVER_HIGHLIGHT_RADIUS_ADDITION_M = UI.SCREEN_SHARE_ICON_RADIUS_M / 2;
...
SIGNALS.NEARBY_DISTANCE_M = 15;

export const PARTICLES: any = {};
PARTICLES.DEFAULT_LINEAR_VELOCITY_M_PER_SEC = 0.2;
